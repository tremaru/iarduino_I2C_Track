...
void setup(){                                 //
     ...
     tlight_1.begin(MODUL_TLIGHT, TRACK_LFR); // * Инициируем работу с 1 светофором без секций поворотов, на перекрёстке можно ехать прямо, налево и направо.
     tlight_2.begin(MODUL_TLIGHT, TRACK_LFR); // * Инициируем работу с 2 светофором без секций поворотов, на перекрёстке можно ехать прямо, налево и направо.
     tlight_3.begin(MODUL_TLIGHT, TRACK_LFR); // * Инициируем работу с 3 светофором без секций поворотов, на перекрёстке можно ехать прямо, налево и направо.
     tlight_4.begin(MODUL_TLIGHT, TRACK_LFR); // * Инициируем работу с 4 светофором без секций поворотов, на перекрёстке можно ехать прямо, налево и направо.
