...
void setup(){                                                //
     ...
     tlight_1.begin(&sWire, MODUL_TLIGHT, TRACK_FLR);        //   Инициируем работу с 1 модулем. Указываем ссылку на объект для работы с шиной I2C, модуль является светофором, дорога прямо налево и направо, без секций поворотов.
     tlight_2.begin(&sWire, MODUL_TLIGHT, TRACK_FRL);        //   Инициируем работу с 2 модулем. Указываем ссылку на объект для работы с шиной I2C, модуль является светофором, дорога прямо налево и направо, без секций поворотов.
     tlight_3.begin(&sWire, MODUL_TLIGHT, TRACK_LFR);        //   Инициируем работу с 3 модулем. Указываем ссылку на объект для работы с шиной I2C, модуль является светофором, дорога прямо налево и направо, без секций поворотов.
     tlight_4.begin(&sWire, MODUL_TLIGHT, TRACK_RFL);        //   Инициируем работу с 4 модулем. Указываем ссылку на объект для работы с шиной I2C, модуль является светофором, дорога прямо налево и направо, без секций поворотов.
