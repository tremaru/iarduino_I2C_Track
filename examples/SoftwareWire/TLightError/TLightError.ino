...
void setup(){                                                  //
     ...
     tlight.begin(&sWire, MODUL_TLIGHT, TRACK_LRF);            //   Инициируем работу с модулем. Указываем ссылку на объект для работы с шиной I2C, модуль является светофором, дорога прямо налево и направо, без секций поворотов.
//   tlight.begin(&sWire, MODUL_TLIGHT, TRACK_RFL);            //   Инициируем работу с модулем. Указываем ссылку на объект для работы с шиной I2C, модуль является светофором, дорога прямо налево и направо, без секций поворотов.
//   tlight.begin(&sWire, MODUL_TLIGHT, TRACK_FLR);            //   Инициируем работу с модулем. Указываем ссылку на объект для работы с шиной I2C, модуль является светофором, дорога прямо налево и направо, без секций поворотов.
//   tlight.begin(&sWire, MODUL_TLIGHT, TRACK_FRL);            //   Инициируем работу с модулем. Указываем ссылку на объект для работы с шиной I2C, модуль является светофором, дорога прямо налево и направо, без секций поворотов.
