...
void setup(){                           //
     ...
     sign_1.begin(MODUL_SIGN, 2,1   );  //   Инициируем работу с модулем. Указываем что модуль является знаком 2.1 ПДД «Главная дорога».
     sign_2.begin(MODUL_SIGN, 2,4   );  //   Инициируем работу с модулем. Указываем что модуль является знаком 2.4 ПДД «Уступите дорогу».
     sign_3.begin(MODUL_SIGN, 2,3,1 );  //   Инициируем работу с модулем. Указываем что модуль является знаком 2.3.1 ПДД «Пересечение со второстепенной дорогой».
