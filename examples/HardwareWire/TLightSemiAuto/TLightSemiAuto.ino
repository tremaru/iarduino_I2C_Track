...
void setup(){                                                       //
     ...
     tlight.begin(&Wire , MODUL_TLIGHT, TRACK_FLR, SECTION_LR);     //   Инициируем работу с модулем. Указываем что модуль находится на шине Wire , является светофором, дорога прямо налево и направо, с двумя секциями поворотов.
//   tlight.begin(&Wire1, MODUL_TLIGHT, TRACK_FRL, SECTION_RL);     //   Инициируем работу с модулем. Указываем что модуль находится на шине Wire1, является светофором, дорога прямо налево и направо, с двумя секциями поворотов.
//   tlight.begin(        MODUL_TLIGHT, TRACK_RLF, SECTION_LRG);    //   Инициируем работу с модулем. Не указываем шину (по умолчанию Wire), модуль является светофором, дорога прямо налево и направо, с двумя секциями поворотов и шлагбаумом.
